...
$service_schema = array(
    ...
    'description' => 'Comprehensive academic enrichment programs for grades 3-8 including Math and ELA. Build strong foundations for future academic success and test preparation.',
    'provider' => array(
    ...
    'hasOfferCatalog' => array(
        ...
        'itemListElement' => array(
            array(
                ...
                'itemOffered' => array(
                    '@type' => 'Service',
                    'name' => 'Math Enrichment (Grades 3-8)'
                )
            ),
            array(
                '@type' => 'Offer',
                'itemOffered' => array(
                    '@type' => 'Service',
                    'name' => 'ELA Enrichment (Grades 3-8)'
                )
            )
        )
    )
