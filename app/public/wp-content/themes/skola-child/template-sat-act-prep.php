...
$service_schema = array(
    ...
    'description' => 'Comprehensive SAT and ACT test prep programs with 96% score improvement rate. Expert instructors, personalized strategies, and proven results for Ivy League-level scores.',
    'provider' => array(
    ...
    'hasOfferCatalog' => array(
        '@type' => 'OfferCatalog',
        'name' => 'SAT/ACT Prep Programs',
        'itemListElement' => array(
            array(
                '@type' => 'Offer',
                'itemOffered' => array(
                    '@type' => 'Service',
                    'name' => 'ACT-SAT Foundational Course'
                )
            ),
            array(
                '@type' => 'Offer',
                'itemOffered' => array(
                    '@type' => 'Service',
                    'name' => 'SAT/ACT Intensive Bootcamp'
                )
            ),
            array(
                '@type' => 'Offer',
