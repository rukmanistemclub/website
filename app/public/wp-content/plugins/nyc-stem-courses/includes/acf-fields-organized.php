...
function nyc_stem_register_organized_course_fields() {
    ...
    acf_add_local_field_group(array(
        ...
        'fields' => array(
            ...
            // Hero Card Stats - Individual fields (ACF Free compatible)
            array(
                'key' => 'field_hero_card_stat_1_number',
                'label' => 'Stat 1 - Number/Value',
                'name' => 'hero_card_stat_1_number',
                'type' => 'text',
                'instructions' => '📈 First stat number (e.g., "96%" or "6-9 Points")',
                'placeholder' => '90%+',
            ),
            array(
                'key' => 'field_hero_card_stat_1_label',
                'label' => 'Stat 1 - Label',
                'name' => 'hero_card_stat_1_label',
                'type' => 'text',
                'instructions' => 'Description for stat 1',
                'placeholder' => 'Score Improvement Rate',
            ),
            array(
                'key' => 'field_hero_card_stat_2_number',
                'label' => 'Stat 2 - Number/Value',
                'name' => 'hero_card_stat_2_number',
                'type' => 'text',
                'placeholder' => '100+',
            ),
            array(
                'key' => 'field_hero_card_stat_2_label',
                'label' => 'Stat 2 - Label',
                'name' => 'hero_card_stat_2_label',
                'type' => 'text',
                'placeholder' => 'Average SAT Increase',
            ),
            array(
                'key' => 'field_hero_card_stat_3_number',
                'label' => 'Stat 3 - Number/Value (Optional)',
                'name' => 'hero_card_stat_3_number',
                'type' => 'text',
                'placeholder' => '',
            ),
            array(
                'key' => 'field_hero_card_stat_3_label',
                'label' => 'Stat 3 - Label (Optional)',
                'name' => 'hero_card_stat_3_label',
                'type' => 'text',
                'placeholder' => '',
            ),
            array(
                'key' => 'field_hero_card_stat_4_number',
                'label' => 'Stat 4 - Number/Value (Optional)',
                'name' => 'hero_card_stat_4_number',
                'type' => 'text',
                'placeholder' => '',
            ),
            array(
                'key' => 'field_hero_card_stat_4_label',
                'label' => 'Stat 4 - Label (Optional)',
                'name' => 'hero_card_stat_4_label',
                'type' => 'text',
                'placeholder' => '',
            ),
